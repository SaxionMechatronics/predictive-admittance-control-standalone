...
class ExperimentLogger:
    ...
    def log_results(self,
                   ...
                   reference_trajectory: Optional[callable] = None) -> str:
        """
    ...
    def _write_header(self, csvfile, experiment_name: str):
        ...
        writer.writerow(['# Position Weight', str(list(self.controller_config.position_weight))])
        writer.writerow(['# Quaternion Weight', self.controller_config.quaternion_weight])
        writer.writerow(['# Velocity Weight', str(list(self.controller_config.velocity_weight))])
    ...
    def _write_data(self, csvfile, results: Dict[str, Any], reference_trajectory: Optional[callable]):
    ...
    def _format_state_row(self,
                         time: float,
                         state: np.ndarray,
                         control: np.ndarray,
                         solve_time: float,
                         reference_trajectory: Optional[callable]) -> list:
